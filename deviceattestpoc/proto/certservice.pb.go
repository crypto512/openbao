...
// This is Phase 2 fallback when TPM lacks manufacturer-provisioned IAK
type ProvisionAIKRequest struct {
	...
	AkPublicKey []byte `protobuf:"bytes,2,opt,name=ak_public_key,json=akPublicKey,proto3" json:"ak_public_key,omitempty"`
...
func (x *ProvisionAIKRequest) Reset() {
	*x = ProvisionAIKRequest{}
	mi := &file_certservice_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProvisionAIKRequest) Descriptor() ([]byte, []int) {
	return file_certservice_proto_rawDescGZIP(), []int{6}
}
...
func (x *ProvisionAIKRequest) GetAkPublicKey() []byte {
	if x != nil {
...
func (x *ProvisionAIKResponse) Reset() {
	*x = ProvisionAIKResponse{}
	mi := &file_certservice_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProvisionAIKResponse) Descriptor() ([]byte, []int) {
	return file_certservice_proto_rawDescGZIP(), []int{7}
}
...
const file_certservice_proto_rawDesc = "" +
	"\n" +
	"\x11certservice.proto\x12\vcertservice\"\xac\x01\n" +
	...
	"\x0fek_root_ca_name\x18\x05 \x01(\tR\fekRootCaName\"\x9a\x01\n" +
	"\x13ProvisionAIKRequest\x121\n" +
	"\x14permanent_identifier\x18\x01 \x01(\tR\x13permanentIdentifier\x12\"\n" +
	"\rak_public_key\x18\x02 \x01(\fR\vakPublicKey\x12,\n" +
...
var (
	...
	file_certservice_proto_rawDescData []byte
)

func file_certservice_proto_rawDescGZIP() []byte {
	file_certservice_proto_rawDescOnce.Do(func() {
		file_certservice_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_certservice_proto_rawDesc), len(file_certservice_proto_rawDesc)))
	})
	return file_certservice_proto_rawDescData
}

var file_certservice_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_certservice_proto_goTypes = []any{
...
func file_certservice_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_certservice_proto_rawDesc), len(file_certservice_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
